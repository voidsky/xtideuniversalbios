...
; Note mods are actually stripping out old XT-CFv2 memory-mapped IO code.
...
JrIdeTransfer_StartWithCommandInAL:
	...
	test		cl, 16				; Bit 4 is cleared on all the read commands,
							; but set on 3 of the 4 write commands
