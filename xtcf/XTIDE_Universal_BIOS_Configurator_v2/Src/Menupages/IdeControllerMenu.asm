...
;		cmp		al, DEVICE_8BIT_XTCF_PIO8_WITH_BIU_OFFLOAD >> 1
;		je		SHORT .ChangingToPioWithOffloadModeXTCF
...
;
;.ChangingToPioWithOffloadModeXTCF:
;		mov		BYTE [es:di], XTCF_8BIT_PIO_MODE_WITH_BIU_OFFLOAD
;		jmp		SHORT .NoNeedToChangeXTCFsettings
;
